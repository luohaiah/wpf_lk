...
namespace Main.com.lk.Constant
{
    class Constant
    {
        ...
        public const string height_score = "身高评分";
        public const string weight = "体重";
        public const string weight_score = "体重评分";
        public const string jump = "立定跳远";
        public const string jump_score = "立定跳远评分";
        public const string vc = "肺活量";
        public const string vc_score = "肺活量评分";
        public const string sitUp = "仰卧起坐";
        public const string sitUp_score = "仰卧起坐评分";
        public const string tiqianqu = "坐位体前屈";
        public const string tiqianqu_score = "坐位体前屈评分";
        public const string pushUp = "俯卧撑";
        public const string pushUp_score = "俯卧撑评分";
        public const string pullUp = "引体向上";
        public const string pullUp_score = "引体向上评分";
        public const string Shuttlerun = "折返跑";
        public const string Shuttlerun_score = "折返跑评分";
